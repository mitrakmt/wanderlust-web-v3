export default function NomadIcon() {
    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" className={`flex-shrink-0 w-6 h-6 mr-8 text-gray-800 transition duration-75 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white`} fill="currentColor" x="0px" y="0px"
