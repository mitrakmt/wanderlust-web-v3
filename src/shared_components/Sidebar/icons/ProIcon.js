export default function ProIcon() {
    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" className={`flex-shrink-0 w-6 h-6 text-gray-800 transition duration-75 dark:text-gray-200 hover:text-primary-700 dark:hover:text-primary-600 transition-colors`} fill="currentColor" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }}>
            <g>
