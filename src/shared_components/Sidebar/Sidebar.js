                                ...
                                return (
                                    <li key={`navbarTabs-desktop-${item.title}`} className="flex items-center relative">
                                        <a onClick={() => { changePage(item.path) } } className={`${item.premiumRequired && !user?.premium ? "disabled pointer-events-none" : ""} flex items-center p-2 text-sm font-normal w-full rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-900 dark:text-white ${currentPath === item.path ? 'bg-gray-100 dark:bg-gray-700' : ''}`}>
                                            {item.icon}
                                            {expanded && <span className={`ml-5 ${item.premiumRequired && !user?.premium ? "text-gray-400" : ""}`}>{item.title}</span>}
                                        </a>
                                        {
                    ...
                    <ul className="pt-4 mt-auto space-y-2">
                                ...
                                return (
                                    <li key={`profileTabs-desktop-${item.title}`}>
                                        <Link href={item.path} className="flex items-center p-2 text-sm font-normal text-gray-900 transition duration-75 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                            {item.icon}
                                            {expanded && <span className={`ml-5 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-900 dark:text-white ${item.authRequired && user ? "text-gray-400" : ""} `}>{item.title}</span>}
                                        </Link>
                                    </li>
                                )
                            })
                        ...
                        <li>
                            <a onClick={toggleTheme} className="flex items-center p-2 text-sm font-normal text-gray-900 transition duration-75 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                {
                                    theme === 'dark' ? <svg xmlns="http://www.w3.org/2000/svg" className={`flex-shrink-0 w-6 h-6 text-gray-800 duration-75 dark:text-gray-200 hover:text-primary-700 dark:hover:text-primary-600 transition-colors`} viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clipRule="evenodd" />
                                        </svg> : <svg xmlns="http://www.w3.org/2000/svg" className={`flex-shrink-0 w-6 h-6 text-gray-800 duration-75 dark:text-gray-200 hover:text-primary-700 dark:hover:text-primary-600 transition-colors`} viewBox="0 0 20 20" fill="currentColor">
