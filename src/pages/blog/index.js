                            ...
                            <div className="w-full mb-4 flex">
                                <div className="w-full flex items-center">
                                    ...
                                    <div className="relative w-full">
                                        ...
                                        <input type="text" onChange={updateSearch} className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search for a city, country or anything!" />
                                    </div>
                                </div>
                                {/* Apply button  */}
