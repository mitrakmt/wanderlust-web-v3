    ...
    return (
        <section className="relative ml-0 sm:ml-16 px-6 py-8">
            <Head>
                ...
                <meta name="description" content="Wanderlust App's Wanderlust Community is the perfect place to connect with other travelers and discover new places. See other traveler's favorite places and get insider information from experienced digital nomads." />

                {/* <!-- Open Graph / Facebook --> */}
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Connect with Travelers and Discover the Best Places with Wanderlust App" />
                <meta property="og:url" content="https://www.wanderlustapp.io/team" />
                <meta property="og:description" content="Wanderlust App's Wanderlust Community is the perfect place to connect with other travelers and discover new places. See other traveler's favorite places and get insider information from experienced digital nomads." />
                <meta property="og:image" content={'/communityDark1.png'} />

                {/* <!-- Twitter --> */}
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="Connect with Travelers and Discover the Best Places with Wanderlust App" />
                <meta property="twitter:url" content="https://www.wanderlustapp.io/team" />
                <meta property="twitter:description" content="Wanderlust App's Wanderlust Community is the perfect place to connect with other travelers and discover new places. See other traveler's favorite places and get insider information from experienced digital nomads." />
                <meta property="twitter:image" content={'/communityDark1.png'} />
            </Head>
