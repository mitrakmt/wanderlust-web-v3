...
export default function WanderlustCommunityFeaturePage() {
    ...
    return (
        <section className="relative ml-0 sm:ml-16 px-6 py-8">
            <Head>
                <title>Connect with Travelers and Discover the Best Places with Wanderlust App</title>
                <meta key="description" name="description" content="Wanderlust App's Wanderlust Community is the perfect place to connect with other travelers and discover new places. See other traveler's favorite places and get insider information from experienced digital nomads." />

                {/* <!-- Open Graph / Facebook --> */}
                <meta key="type" property="og:type" content="website" />
                <meta key="title" property="og:title" content="Connect with Travelers and Discover the Best Places with Wanderlust App" />
                <meta key="url" property="og:url" content="https://www.wanderlustapp.io/team" />
                <meta key="description" property="og:description" content="Wanderlust App's Wanderlust Community is the perfect place to connect with other travelers and discover new places. See other traveler's favorite places and get insider information from experienced digital nomads." />
                <meta key="image" property="og:image" content={'/communityDark1.png'} />

                {/* <!-- Twitter --> */}
                <meta key="card" property="twitter:card" content="summary_large_image" />
                <meta key="title" property="twitter:title" content="Connect with Travelers and Discover the Best Places with Wanderlust App" />
                <meta key="url" property="twitter:url" content="https://www.wanderlustapp.io/team" />
                <meta key="description" property="twitter:description" content="Wanderlust App's Wanderlust Community is the perfect place to connect with other travelers and discover new places. See other traveler's favorite places and get insider information from experienced digital nomads." />
                <meta key="image" property="twitter:image" content={'/communityDark1.png'} />
            </Head>
