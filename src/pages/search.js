                            ...
                            searchRandomCityByRegionLoading ?
                                ...
                                <div className="flex flex-col md:flex-row justify-center items-center">
                                    ...
                                    <div className="flex flex-wrap justify-center items-center">
                                        <button type="button" onClick={() => findRandomLocationByRegion('Asia')} disabled={searchRandomCityByRegionLoading} className="inline-flex my-1 items-center px-2 py-1 ml-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Asia
                                        </button>
                                        <button type="button" onClick={() => findRandomLocationByRegion('Europe')} disabled={searchRandomCityByRegionLoading} className="inline-flex my-1 items-center px-2 py-1 ml-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Europe
                                        </button>
                                        <button type="button" onClick={() => findRandomLocationByRegion('Oceania')} disabled={searchRandomCityByRegionLoading} className="inline-flex my-1 items-center px-2 py-1 ml-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Oceania
                                        </button>
                                        <button type="button" onClick={() => findRandomLocationByRegion('North America')} disabled={searchRandomCityByRegionLoading} className="inline-flex my-1 items-center px-2 py-1 ml-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            North America
                                        </button>
                                        <button type="button" onClick={() => findRandomLocationByRegion('Latin America')} disabled={searchRandomCityByRegionLoading} className="inline-flex my-1 items-center px-2 py-1 ml-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Latin America
                                        </button>
                                    </div>
                                </div>
