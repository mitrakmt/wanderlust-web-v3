    ...
    return (
        <section className="relative ml-0 sm:ml-16 px-6 py-8">
            <Head>
                ...
                <meta key="description" name="description" content="Take your travel planning to the next level with Wanderlust App Pro. Join our premium membership program and unlock exclusive features and tools to help you explore the world like a pro. Enjoy benefits such as personalized travel recommendations, priority customer support, and discounts on select bookings. Upgrade to Wanderlust App Pro today and elevate your travel experience." />

                {/* <!-- Open Graph / Facebook --> */}
                <meta key="type" property="og:type" content="website" />
                <meta key="title" property="og:title" content="Elevate Your Travel Experience | Join Wanderlust App Pro Today" />
                <meta key="url" property="og:url" content="https://www.wanderlustapp.io/pro" />
                <meta key="description" property="og:description" content="Take your travel planning to the next level with Wanderlust App Pro. Join our premium membership program and unlock exclusive features and tools to help you explore the world like a pro. Enjoy benefits such as personalized travel recommendations, priority customer support, and discounts on select bookings. Upgrade to Wanderlust App Pro today and elevate your travel experience." />
                {/* <meta property="og:image" content={blog?.image_url} /> */}

                {/* <!-- Twitter --> */}
                <meta key="card" property="twitter:card" content="summary_large_image" />
                <meta key="title" property="twitter:title" content="Elevate Your Travel Experience | Join Wanderlust App Pro Today" />
                <meta key="url" property="twitter:url" content="https://www.wanderlustapp.io/pro" />
                <meta key="description" property="twitter:description" content="Take your travel planning to the next level with Wanderlust App Pro. Join our premium membership program and unlock exclusive features and tools to help you explore the world like a pro. Enjoy benefits such as personalized travel recommendations, priority customer support, and discounts on select bookings. Upgrade to Wanderlust App Pro today and elevate your travel experience." />
