...
export default function MyApp({ Component, pageProps }) {
    ...
    return (
        <div className={`overflow-scroll h-full max-h-screen scroll-smooth ${roboto.variable} font-sans`}>
            <Head>
                <meta name="7searchppc" content="te1j72BstIUMDlD7BvMRHdiSCv"/>
            </Head>
                                                            ...
                                                            <Layout>
                                                                <ErrorBoundary>
                                                                    <CustomHead
                                                                        ...
                                                                        description="Wanderlust App is your ultimate travel companion, helping you plan and organize every aspect of your trip. From finding the best flights and accommodations to creating custom itineraries based on your interests, our app makes travel planning easy and stress-free."
