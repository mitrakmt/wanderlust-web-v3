    ...
    return (
        <div className="pl-16 flex flex-col items-center">
            <div className="w-4/5 py-8 max-w-screen-xl text-center my-32">
                <a className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 rounded-full dark:text-white" role="alert">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 my-8">
                <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                    ...
                    <p className="font-light text-gray-700 lg:mb-16 sm:text-xl dark:text-gray-200">Every traveler has a wealth of information waiting to be shared</p>
                </div> 
            ...
            <div className="w-4/5 py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                    ...
                    <p className="font-light text-gray-700 sm:text-xl dark:text-gray-100">We help you to learn about the best places around the world, the most beautiful places to see, and everything you'd need as a nomad.</p>
                </div> 
