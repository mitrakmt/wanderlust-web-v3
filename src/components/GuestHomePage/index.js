    ...
    return(
        <div className="w-full absolute overflow-scroll top-0 left-0 ml-0 sm:ml-16 md:ml-16 lg:ml-0 flex flex-col justify-center items-center min-h-screen bg-gray-200/90 dark:bg-gray-900/90" style={{ zIndex: 49 }}>
            <div className="w-4/5 py-8 max-w-screen-xl text-center my-32">
                ...
                <p className="mb-8 text-lg font-normal text-gray-700 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-300">Wanderlust App let's you to find, explore and share the best places around the world, and gives you the tools to plan everything you'd need.</p>
            ...
            <div className="w-4/5 gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                    <img className="relative w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/office-long-2.png" alt="office content 1" />
                    <img className="relative mt-4 w-full lg:mt-10 rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/office-long-1.png" alt="office content 2" />
                </div>
            </div>
            {/* CTA  */}
            <div className="w-4/5 py-8 mx-auto max-w-screen-xl text-center my-32">
                ...
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <a onClick={() => router.push('/blog/blogPost1')} className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Signup for free
                        <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                    </a>
                    <a onClick={() => router.push('/search')} className="cursor-pointer inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                        Search for a place
                    </a>  
                </div>
            </div>
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 my-8">
                <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                    ...
                    <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Every traveler has a wealth of information waiting to be shared</p>
                </div> 
