        ...
        <div className="flex flex-wrap items-center justify-between">
          <div className="flex items-center flex-1 w-0">
            <span className="flex p-2 bg-indigo-800 rounded-lg">
              <SpeakerphoneIcon className="w-6 h-6 dark:text-white" aria-hidden="true" />
            </span>
            <p className="ml-3 font-medium truncate dark:text-white">
              <span className="md:hidden">We announced a new product!</span>
              <span className="hidden md:inline">Big news! We&lsquo;re excited to announce a brand new product.</span>
            </p>
          </div>
          ...
          <div className="flex-shrink-0 order-2 sm:order-3 sm:ml-3">
            ...
            >
              ...
              <XIcon className="w-6 h-6 dark:text-white" aria-hidden="true" />
            </button>
          </div>
        </div>
      </div>
