        ...
        <>
            <div className="block">
                <div className="flex mb-6">
                    <p className="bg-blue-100 text-blue-800 text-sm font-semibold inline-flex items-center p-1.5 rounded dark:bg-blue-200 dark:text-blue-800">{citySelected?.total_score?.toFixed(1)}</p>               
