...
const ProductDisplay = ({ loading, setLoading, stripeCustomerId }) => {
  if (loading) {
    return (
      <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex justify-center items-center w-full">
    ...
    return (
      <button type="button" onClick={() => checkout({ setLoading, stripeCustomerId })} className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Unlock Premium Features</button>
    )
  }
}
