                                    ...
                                    <tr key={`cityRow-${pageIndex}-${city.id}`} className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <div className="flex items-center">
                                                <div className={`inline-block w-4 h-4 mr-2 ${city.air_quality_score <= 3 ? "bg-red-700" : city.air_quality_score < 4 ? "bg-yellow-700" : "bg-green-700"} rounded-full`}></div>
                                        ...
                                        <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{city.cost_score.toFixed(0)}</td>
                                        <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{city.leisure_quality}</td>
                                        <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div className="flex">
