...
export default function BlogCard({ post }) {
    ...
    return (
        <article key={`blogCard-${post.id}-${post.author.name}`} className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
