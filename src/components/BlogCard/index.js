...
export default function BlogCard({ post }) {
    ...
    return (
        <article className="p-6 h-full flex flex-col justify-between bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex justify-between">
                ...
                <Link href={{ pathname: "/blog/[slug]", query: { slug: post.slug } }} className="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                    Read more
