...
export default function CityEmbed({ id }) {
    ...
    return (
        <div className="rounded-lg overflow-hidden">
            <table className="shadow-md w-full pl-4 border-solid border-gray-300 dark:border-gray-600 border text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" className="px-4 pr-6 py-3" style={{ paddingLeft: '14px' }}>Name</th>
                ...
                <tbody>
                    <tr key={`cityEmbed-${city.id}`} className="border-b dark:border-gray-600">
                        <th scope="row" className="flex items-center px-2 py-1 pr-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {
