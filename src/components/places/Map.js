        ...
        >
            ...
            {selectedMarker && (
                <div className="absolute bottom-10 left-2">
                    <PlaceCard isPublicMap={isPublicMap} google_id={selectedMarker.google_id} id={selectedMarker.id} tags={selectedMarker.tags} name={selectedMarker.name} closePlaceOverlay={closePlaceOverlay} removePlace={removePlace} />
                </div>
            )}
        </Map>
