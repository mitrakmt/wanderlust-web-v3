        ...
        <footer className="bg-gray-100 dark:bg-gray-900/90 w-full">
            ...
            <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                    ...
                    <a href="https://www.instagram.com/wanderlustext/" target="_blank" className="text-gray-400 hover:text-gray-900 dark:hover:text-white" aria-label="Read more from Wanderlust on Instagram">
