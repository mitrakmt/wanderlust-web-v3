...
export default function PopularTravelers() {
    const travelers = [
        ...
        },
        {
            name: 'Olivia Jones',
            title: '8 countries',
            username: "oliviajones23",
            description: 'Ava Perez is a skilled digital marketer and global traveler who leverages her expertise to help businesses thrive in the digital age, while experiencing different cultures and lifestyles.',
            avatar: 'https://wanderlust-extension.s3.us-west-2.amazonaws.com/64141da0e59167a1bb6e65e1',
        },
        {
            name: 'Emma Davis',
            title: '20 countries',
            username: "emmadavis17",
            description: 'Emma Davis is a talented designer and digital nomad who creates beautiful and functional designs while exploring new destinations around the world.',
            avatar: 'https://wanderlust-extension.s3.us-west-2.amazonaws.com/64154f0525f4c88cc0bf2c0f',
        },
        {
            name: 'Ava Perez',
            title: '21 countries',
            username: "avaperez21",
            description: 'Ava is a digital nomad and freelance writer who travels the world in search of adventure and inspiration.',
            avatar: 'https://wanderlust-extension.s3.us-west-2.amazonaws.com/6415514725f4c88cc0bf2db4',
        },
    ]
