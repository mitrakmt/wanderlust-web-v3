        ...
        <div className="px-2 sm:pl-16 pr-0 flex flex-col items-center">
            <div className="w-4/5 py-8 max-w-screen-xl text-center my-36">
                ...
                <div className="px-4 mx-auto flex flex-col items-center justify-center text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                    ...
                    <div className="flex flex-wrap justify-center items-center mt-8 px-2 py-2 rounded-full text-gray-700 dark:text-gray-300 sm:justify-between bg-gray-100 dark:bg-gray-700">
            ...
            <div className="w-4/5 gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6 bg-white/90 dark:bg-gray-800/90 rounded-lg">
                <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Why I created Wanderlust</h2>
            ...
            <div className="w-4/5 py-8 mx-auto max-w-screen-xl text-center my-32 bg-white/90 dark:bg-gray-800/90 rounded-lg">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <a onClick={() => router.push('/blog/blogPost1')} className="cursor-pointer inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Signup for free
                        <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                    </a>
