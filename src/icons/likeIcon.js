    ...
    return (
        <div className={`flex items-center justify-center w-12 h-12 transition-all ${noBackground ? "" : "bg-gray-200 mx-2 dark:bg-gray-700/80"} rounded-full cursor-pointer`}>
            <svg
                ...
                fill={currentImageFavoriteStatus ? "rgb(165, 0, 0)" : iconHovered ? "#b1b1b1" : "none"}
                stroke={currentImageFavoriteStatus ? "rgb(165, 0, 0)" : iconHovered ? "#b1b1b1" : "#c3c2c7"}
                strokeWidth="2"
                style={{ zIndex: 100 }}
                strokeLinecap="round"
                strokeLinejoin="round"
                className={`feather feather-refresh-cw featherButton`}
            >
