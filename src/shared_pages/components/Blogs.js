            ...
            <div>
                {
                    recommendedBlogs.map(blog => (
                        <article key={`recommendedBlogs-${blog.title}`} className="p-4 mb-4 bg-gray-100 rounded-lg border border-gray-200 shadow-md dark:bg-gray-700 dark:border-gray-700">
                            ...
                            <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><Link href={{ pathname: "/blog/[slug]", query: { slug: blog.slug } }}>{blog.title}</Link></h2>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <Link href={{ pathname: "/blog/[slug]", query: { slug: blog.slug } }} className="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                                    Read more
