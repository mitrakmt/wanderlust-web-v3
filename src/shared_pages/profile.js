                        ...
                        {user?.id !== profileUser?.id && (
                            <div className="absolute right-4 sm:right-8 top-4">
                                {follows.includes(profileUser?.id) ? (
                                    <button type="button" onClick={removeFollow} className="px-3 py-2 text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Unfollow</button>
                                ) : (
                                    <button type="button" onClick={followUser} className="px-3 py-2 text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Follow</button>
                                )}
                            </div>
                        )}
                        {/* Profile image  */}
                        ...
                        <div className="flex flex-col mt-4">
                            <div className="flex flex-col mb-4">
                                <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
                                    <div>
                                        <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{profileUser?.name}</h5>
                            ...
                            <div className="">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 text-sm">Joined {moment(profileUser?.createdAt).format('MMMM Do YYYY')}</p>
                            </div>
                        </div>
                    </div>
                    {/* Maps  */}
